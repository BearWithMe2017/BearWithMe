...
public class MenuSelection : MonoBehaviour
{
    ...
    void Update()
    {
        if (MenuSelectionStartActive == true)
        {
            MenuSlectionStartImage.transform.localScale = new Vector3(Mathf.PingPong(Time.time * 1, 1), MenuSlectionStartImage.transform.localScale.x, MenuSlectionStartImage.transform.localScale.y);
        }
        ...
        if (MenuSelectionOptionsActive == true)
        {
            MenuSlectionOptionsImage.transform.localScale = new Vector3(Mathf.PingPong(Time.time * 1, 1), MenuSlectionOptionsImage.transform.localScale.x, MenuSlectionOptionsImage.transform.localScale.y);
        }
        ...
        if (MenuSelectionControlsActive == true)
        {
            MenuSlectionControlsImage.transform.localScale = new Vector3(Mathf.PingPong(Time.time * 1, 1), MenuSlectionControlsImage.transform.localScale.x, MenuSlectionControlsImage.transform.localScale.y);
        }
        ...
        if (MenuSelectionQuitActive == true)
        {
            MenuSlectionQuitImage.transform.localScale = new Vector3(Mathf.PingPong(Time.time * 1, 1), MenuSlectionQuitImage.transform.localScale.x, MenuSlectionQuitImage.transform.localScale.y);
        }
        ...
        else if (isPaused)
        {
            ...
            if (Input.GetKeyDown(KeyCode.Backspace) & ControlsPanel.activeSelf == true)
            {
