...
public class MatchSettings : MonoBehaviour {
    ...
    private float Wins1value /* = 30 seconds */;
    private float Wins2value /* = 1 minute */;
    private float Wins3value /* = 1 minute 30 seconds */;
    private float Wins4value /* = 2 minutes */;
    private float Wins5value /* = 2 minutes 30 seconds */;
    ...
    void Update()
    {
        ...
        // wins
        {
            ...
            {
                print("Change win setting up one");
                if (Wins1.activeSelf == true)
                {
                    Wins1.SetActive(false);
                    Wins2.SetActive(true);
