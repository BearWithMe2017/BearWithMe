    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_3089 = ((_FlowMap_var.rgb.rg*2.0+-1.0)*_FlowPower*1.0);
...
////// Specular:
                ...
                float3 diffuseColor = (lerp(lerp((lerp(node_7446,float3(1,1,1),(node_3410*_ReflectionTint))*_ReflectionText_var.rgb),node_7446,(node_9210 + ( (node_3410 - node_3376) * ((1.0 - _ReflectionMin) - node_9210) ) / (1.0 - node_3376))),lerp(node_3340.rgb,node_6980.rgb,node_7873),node_8676)+node_4741); // Need this for specular when using metallic
