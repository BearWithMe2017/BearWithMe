...
////// Lighting:
////// Emissive:
                float4 node_6151 = _Time;
                float2 node_1588 = (i.uv0+node_6151.g*float2(0.05,0.05));
                ...
                float3 emissive = (((node_4767.rgb-(1.0 - _Thickness))*_Opacity)*i.vertexColor.a*2.0);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_8361 = _Time;
                float2 node_1588 = (i.uv0+node_8361.g*float2(0.05,0.05));
                float4 _node_4010_var = tex2D(_node_4010,TRANSFORM_TEX(node_1588, _node_4010));
                float2 node_1261 = ((_node_4010_var.g*0.01+0.0)+(i.uv0*1.0));
                float4 node_4767 = tex2D(_Caustic,TRANSFORM_TEX(node_1261, _Caustic));
                o.Emission = (((node_4767.rgb-(1.0 - _Thickness))*_Opacity)*i.vertexColor.a*2.0);
