...
Shader "Custom/CelShader" {
    Properties {
        ...
        _node_4621_copy ("node_4621_copy", Float ) = 1
        _node_4621_copy ("node_4621_copy", Float ) = 1
        _node_4621_copy ("node_4621_copy", Float ) = 1
...
////// Emissive:
                ...
                float3 emissive = ((_ColourMap_var.rgb*_ObjectTint.rgb)*UNITY_LIGHTMODEL_AMBIENT.rgb);
                float3 node_2195 = (max(0,dot(lightDirection,normalDirection))*_node_1505.rgb*attenuation);
                ...
                float3 node_1955 = (max(0,dot(lightDirection,normalDirection))*lerp(_LightColor0.rgb,dot(_LightColor0.rgb,float3(0.3,0.59,0.11)),_Saturation)*attenuation);
                float node_993 = 0.3;
                float node_4651 = floor(clamp((node_1955+node_993),0.0,1.0) * _Steps) / (_Steps - 1);
                float3 finalColor = emissive + (lerp( lerp( lerp( (node_9773*node_4651), _GlossColour.rgb, step((1.0 - _GlossLevel),(node_2195-0.45)).r ), _GlossColour.rgb, step((1.0 - _GlossLevel),(node_2195-0.45)).g ), _GlossColour.rgb, step((1.0 - _GlossLevel),(node_2195-0.45)).b ));
...
////// Lighting:
                ...
                float node_993 = 0.3;
                float node_4651 = floor(clamp((node_1955+node_993),0.0,1.0) * _Steps) / (_Steps - 1);
                float3 finalColor = (lerp( lerp( lerp( (node_9773*node_4651), _GlossColour.rgb, step((1.0 - _GlossLevel),(node_2195-0.45)).r ), _GlossColour.rgb, step((1.0 - _GlossLevel),(node_2195-0.45)).g ), _GlossColour.rgb, step((1.0 - _GlossLevel),(node_2195-0.45)).b ));
